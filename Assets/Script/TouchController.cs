...
public class TouchController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        controls.XboxController.Left.performed += ctx => Left();
        controls.XboxController.Right.performed += ctx => Right();
        controls.XboxController.Up.performed += ctx => Up();
        controls.XboxController.Down.performed += ctx => Down();
